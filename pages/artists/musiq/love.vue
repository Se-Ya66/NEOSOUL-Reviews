...
let url = "https://www.googleapis.com/youtube/v3/videos?id=OIKC2ggCed4&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'OIKC2ggCed4',
            imgurl:'https://i.ytimg.com/vi/OIKC2ggCed4/mqdefault.jpg',
            songtitle:"Love'",
            artist:"Musiq",
            ytlink:'https://www.youtube.com/watch?v=OIKC2ggCed4',
            tag:'/artists/musiq/love',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        getNumber(){
            ...
            let ref = db.ref('like2').child('love');
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('love').child('count');
            let ref2 = db.ref('like2').child('liked').child('love');
            let self = this;
