...
let url = "https://www.googleapis.com/youtube/v3/videos?id=5XJry6RshJo&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'5XJry6RshJo',
            imgurl:'https://i.ytimg.com/vi/5XJry6RshJo/mqdefault.jpg',
            songtitle:"Girl Next Door'",
            artist:"Musiq",
            ytlink:'https://www.youtube.com/watch?v=5XJry6RshJo',
            tag:'/artists/musiq/girl',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        getNumber(){
            ...
            let ref = db.ref('like2').child('girl');
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('girl').child('count');
            let ref2 = db.ref('like2').child('liked').child('girl');
            let self = this;
