...
let url = "https://www.googleapis.com/youtube/v3/videos?id=OqN0jsSeqPo&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'OqN0jsSeqPo',
            imgurl:'https://i.ytimg.com/vi/OqN0jsSeqPo/mqdefault.jpg',
            songtitle:'Bag Lady',
            artist:"Erykah Badu",
            ytlink:'https://www.youtube.com/watch?v=OqN0jsSeqPo',
            tag:'/artists/erykah/bag',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        ...
        getNumber(){
            ...
            let ref = db.ref('like2').child('bag');
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('bag').child('count');
            let ref2 = db.ref('like2').child('liked').child('bag');
            let self = this;
