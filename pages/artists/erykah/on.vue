...
let url = "https://www.googleapis.com/youtube/v3/videos?id=-CPCs7vVz6s&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'-CPCs7vVz6s',
            imgurl:'https://i.ytimg.com/vi/-CPCs7vVz6s/mqdefault.jpg',
            songtitle:'On & On',
            artist:"Erykah Badu",
            ytlink:'https://www.youtube.com/watch?v=-CPCs7vVz6s',
            tag:'/artists/erykah/on',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('on').child('count');
            let ref2 = db.ref('like2').child('liked').child('on');
            let self = this;
