...
let url = "https://www.googleapis.com/youtube/v3/videos?id=DGSX8GsdN-s&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'DGSX8GsdN-s',
            imgurl:'https://i.ytimg.com/vi/DGSX8GsdN-s/mqdefault.jpg',
            songtitle:"I Can't Wait",
            artist:"Lalah Hathaway",
            ytlink:'https://www.youtube.com/watch?v=DGSX8GsdN-s',
            tag:'/artists/lalah/cant',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        getNumber(){
            ...
            let ref = db.ref('like2').child('cant');
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('cant').child('count');
            let ref2 = db.ref('like2').child('liked').child('cant');
            let self = this;
