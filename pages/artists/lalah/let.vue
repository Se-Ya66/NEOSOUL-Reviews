...
let url = "https://www.googleapis.com/youtube/v3/videos?id=fUXXhRlXFkk&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'fUXXhRlXFkk',
            imgurl:'https://i.ytimg.com/vi/fUXXhRlXFkk/mqdefault.jpg',
            songtitle:"Let go",
            artist:"Lalah Hathaway",
            ytlink:'https://www.youtube.com/watch?v=fUXXhRlXFkk',
            tag:'/artists/lalah/let',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        getNumber(){
            ...
            let ref = db.ref('like2').child('let');
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('let').child('count');
            let ref2 = db.ref('like2').child('liked').child('let');
            let self = this;
