...
let url = "https://www.googleapis.com/youtube/v3/videos?id=rp8WYwE3LUI&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'rp8WYwE3LUI',
            imgurl:'https://i.ytimg.com/vi/rp8WYwE3LUI/mqdefault.jpg',
            songtitle:"Get to Know Ya",
            artist:"Maxwell",
            ytlink:'https://www.youtube.com/watch?v=rp8WYwE3LUI',
            tag:'/artists/maxwell/get',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        getNumber(){
            ...
            let ref = db.ref('like2').child('get');
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('get').child('count');
            let ref2 = db.ref('like2').child('liked').child('get');
            let self = this;
