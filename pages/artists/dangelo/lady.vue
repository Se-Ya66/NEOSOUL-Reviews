...
let url = "https://www.googleapis.com/youtube/v3/videos?id=YBB8valskCQ&key=" + process.env.YOUTUBE_API_KEY + "&part=snippet,contentDetails,statistics,status";
...
export default {
    ...
    data(){
        return{
            ...
            data_ob:{},
            num:'YBB8valskCQ',
            imgurl:'https://i.ytimg.com/vi/YBB8valskCQ/mqdefault.jpg',
            songtitle:'Lady',
            artist:"D'Angelo",
            ytlink:'https://www.youtube.com/watch?v=YBB8valskCQ',
            tag:'/artists/dangelo/lady',
            items: [
                {
                    text: 'HOME',
                    disabled: false,
    ...
    methods:{
        getNumber(){
            ...
            let ref = db.ref('like2').child('lady');
        ...
        addLike(){
            ...
            let userId = user.uid;
            let ref = db.ref('like2').child('lady').child('count');
            let ref2 = db.ref('like2').child('liked').child('lady');
            let self = this;
